  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text fontSize="21px" textAlign="center" fontWeight="bold" mb="1rem">
            ...
            >
              <Group attached w="full" maxW="sm">
                ...
                >
                  ...
                  {erroSenhaAtual && <Text color="red.500">{erroSenhaAtual}</Text>}
              ...
              <Group attached w="full" maxW="sm" mt='1rem'>
                <Input
                  ...
                  w={{ base: "200px", md: "250px", lg: "350px" }}
                  padding=".5rem"
                  borderColor={erroNova ||  erroConfirmar ? "red.400" : "#609ED4"}
                  borderRight="none"
                  value={novaSenha}
